...
public class CandidateTalentsController {
	...
	public DataResult<List<CandidateTalent>> findByCandidateId(@RequestParam int id) {
		...
		return this.candidateTalentService.findByCandidateId(id);
	}
	
	@DeleteMapping("/deleteTalent")
    public Result deleteTechnology(@RequestParam int talentId){
        return this.candidateTalentService.deleteTalent(talentId);
    }
}
